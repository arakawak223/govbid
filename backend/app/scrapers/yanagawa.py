...
class YanagawaScraper(BaseScraper):
    """Scraper for Yanagawa City (柳川市)"""

    municipality_name = "柳川市"
    base_url = "https://www.city.yanagawa.fukuoka.jp"
    bid_list_url = "https://www.city.yanagawa.fukuoka.jp/oshirase/b1-nyusatsu/"
