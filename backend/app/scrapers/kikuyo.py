...
class KikuyoScraper(BaseScraper):
    """Scraper for Kikuyo Town (菊陽町)"""

    municipality_name = "菊陽町"
    base_url = "https://www.town.kikuyo.lg.jp"
    bid_list_url = "https://www.town.kikuyo.lg.jp/list00143.html"
