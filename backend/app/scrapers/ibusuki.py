...
class IbusukiScraper(BaseScraper):
    """Scraper for Ibusuki City (指宿市)"""

    municipality_name = "指宿市"
    base_url = "https://www.city.ibusuki.lg.jp"
    bid_list_url = "https://www.city.ibusuki.lg.jp/main/info/collect/"
