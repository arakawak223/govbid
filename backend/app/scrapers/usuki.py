...
class UsukiScraper(BaseScraper):
    """Scraper for Usuki City (臼杵市)"""

    municipality_name = "臼杵市"
    base_url = "https://www.city.usuki.oita.jp"
    bid_list_url = "https://www.city.usuki.oita.jp/categories/jigyosha/nyusatsu/proposal/"
