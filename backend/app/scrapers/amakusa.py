...
class AmakusaScraper(BaseScraper):
    """Scraper for Amakusa City (天草市)"""

    municipality_name = "天草市"
    base_url = "https://www.city.amakusa.kumamoto.jp"
    bid_list_url = "https://www.city.amakusa.kumamoto.jp/list00725.html"
