...
class UrasoeScraper(BaseScraper):
    """Scraper for Urasoe City (浦添市)"""

    municipality_name = "浦添市"
    base_url = "https://www.city.urasoe.lg.jp"
    bid_list_url = "https://www.city.urasoe.lg.jp/category/kubun/news/"
