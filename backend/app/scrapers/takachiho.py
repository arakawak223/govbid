...
class TakachihoScraper(BaseScraper):
    """Scraper for Takachiho Town (高千穂町)"""

    municipality_name = "高千穂町"
    base_url = "https://www.town-takachiho.jp"
    bid_list_url = "https://www.town-takachiho.jp/top/news.html"
