...
class YufuScraper(BaseScraper):
    """Scraper for Yufu City (由布市)"""

    municipality_name = "由布市"
    base_url = "https://www.city.yufu.oita.jp"
    bid_list_url = "https://www.city.yufu.oita.jp/biz/nyuusatukeiyaku/article_83098/article_83099"
