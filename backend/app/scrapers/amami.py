...
class AmamiScraper(BaseScraper):
    """Scraper for Amami City (奄美市)"""

    municipality_name = "奄美市"
    base_url = "https://www.city.amami.lg.jp"
    bid_list_url = "https://www.city.amami.lg.jp/shinchaku/index.html"
