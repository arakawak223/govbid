...
class GotoScraper(BaseScraper):
    """Scraper for Goto City (五島市)"""

    municipality_name = "五島市"
    base_url = "https://www.city.goto.nagasaki.jp"
    bid_list_url = "https://www.city.goto.nagasaki.jp/li/050/020/060/index.html"
