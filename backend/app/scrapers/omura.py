...
class OmuraScraper(BaseScraper):
    """Scraper for Omura City (大村市)"""

    municipality_name = "大村市"
    base_url = "https://www.city.omura.nagasaki.jp"
    bid_list_url = "https://www.city.omura.nagasaki.jp/shise/nyusatsu/koubo/index.html"
