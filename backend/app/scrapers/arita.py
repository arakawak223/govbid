...
class AritaScraper(BaseScraper):
    """Scraper for Arita Town (有田町)"""

    municipality_name = "有田町"
    base_url = "https://www.town.arita.lg.jp"
    bid_list_url = "https://www.town.arita.lg.jp/list00224.html"
